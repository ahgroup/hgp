...
Zane has absolutely no idea where this came from or how to fix it. It started
showing up when I added the model de-chunker function, but even after reverting
the commit and everything it still seems to show up. Hopefully it doesn't
matter.
